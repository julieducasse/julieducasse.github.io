...
Obviously I won't show it here, because it contains personal things, but I'll show some plots (or parts of plots) that I did with various chats, to illustrate what can be done with Telegram data.
...
I created one word cloud with one with 6 months of conversation with one of my colleagues (aka CC) and I found it nice that:
